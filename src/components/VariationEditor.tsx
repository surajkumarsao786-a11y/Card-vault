...
export function VariationEditor({ id, initialText, onSave }: VariationEditorProps) {
  ...
  return (
    <div className="flex flex-col gap-2 p-4 bg-bg-surface-hover rounded-2xl border border-border-main backdrop-blur-md transition-all focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
