...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div {...handlers} className="h-[100dvh] bg-bg-main text-text-main font-sans flex flex-col pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] transition-colors duration-300">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 w-72 bg-bg-surface z-50 transform transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} flex flex-col border-r border-border-main`}>
