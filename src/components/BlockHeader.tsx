...
export function BlockHeader({ title, isExpanded, onToggle, onTitleChange, onOptionsClick, dragControls }: BlockHeaderProps) {
  ...
  return (
    ...
    >
      <input
        ...
        onBlur={handleBlur}
        className="bg-transparent text-lg font-semibold outline-none flex-1 mr-2 cursor-text"
      ...
      <div className="flex items-center gap-1">
        <button 
          ...
          onPointerDown={(e) => e.stopPropagation()} // Prevent dragging when clicking options
          className="p-2 rounded-full hover:bg-bg-surface-hover transition-colors text-text-muted"
        >
